...
class AllServicesFailoverResilienceIT {
    ...
    private static final String CLUSTER_MANAGER = "http://localhost:9090";

    @Test
    void allServicesRecoverThroughLoadBalancerFailover() throws Exception {
        assertTrue(checkClusterManager(CLUSTER_MANAGER),
                "ClusterManager is not reachable at " + CLUSTER_MANAGER);
